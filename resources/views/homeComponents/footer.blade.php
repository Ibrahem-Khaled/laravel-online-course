        ...
        <div class="row gy-5">
            ...
            <div class="col-lg-3 col-md-6 footer-section">
                ...
                <ul class="footer-links">
                    <li><a href="#">المسار التعليمي</a></li>
            ...
            <div class="col-lg-6 footer-section contact-info">
                ...
                <div class="contact-details">
                    <p class="d-flex align-items-center justify-content-end gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="#ed6b2f">
                    ...
                    <p class="d-flex align-items-center justify-content-end gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="#ed6b2f">
                            <path d="M12 12.713l-11.985-9.713h23.97l-11.985 9.713zm0 2.574l-12-9.725v15.438h24v-15.438l-12 9.725"/>
                        </svg>
